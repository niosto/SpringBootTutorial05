...
public class ProductController {
    private static List<Map<String, String>> products = new ArrayList<>(List.of(
        Map.of("id", "1", "name", "TV", "description", "Best TV","price","1599"),
        Map.of("id", "2", "name", "iPhone", "description", "Best iPhone","price","899"),
        Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast","price","999"),
        Map.of("id", "4", "name", "Glasses", "description", "Best Glasses","price","249")
    ));
